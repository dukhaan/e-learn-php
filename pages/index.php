            ...
            <?php if ($_SESSION['role'] == 'admin') : ?>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="admin/majors/index.php">Program Studi</a></li>
                  <li><a class="nav-link" href="admin/grades/index.php">Kelas</a></li>
                  <li><a class="nav-link" href="admin/subjects/index.php">Mata Kuliah</a></li>
                </ul>
              </li>
              <li class="nav-item">
